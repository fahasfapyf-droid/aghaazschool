...
type MonitorData = {
  ...
  summary: { activeStudents: number; attendanceExceptions: number; overdueFees: number; failingResults: number; overdueHomework: number; activeAdmissions: number; staffAttendanceExceptions: number };
  exceptions: {
    attendance: { studentId: string; attendancePercent: number; total: number }[];\n    staffAttendance: { staffId: string; staffName: string; employeeNumber: string; status: string; date: string }[];
