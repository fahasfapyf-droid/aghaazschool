...
export default function AdminPage() {
  ...
  async function createUser(event: FormEvent) {
    ...
    try {
      const r = await fetch("/api/admin/users", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, phone, email, password, role, staffId: staffId || null }) });
      ...
      setName(""); setPhone(""); setEmail(""); setPassword(""); setRole("RECEPTIONIST"); setStaffId("");
      await load();
