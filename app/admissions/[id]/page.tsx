...
export default function AdmissionDetail(){
 ...
 async function changeStatus(status:string){
   ...
   try{const r=await fetch(`/api/admissions/${id}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify({status})});const d=await r.json();if(!r.ok)throw Error(d.error||"Unable to update status");setApp({...app,...d})}
