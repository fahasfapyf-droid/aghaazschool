...
export async function GET(request: NextRequest) {
  try {
    ...
    const statusFilter = statusParam === "FORMER" ? ["LEFT", "left", "EXPELLED", "expelled", "WITHDRAWN", "withdrawn", "TRANSFERRED", "transferred", "INACTIVE", "inactive"] : statusParam === "ENROLLED" ? ["ACTIVE", "active", "ENROLLED", "enrolled"] : statusParam && statusParam !== "ALL" ? [statusParam, statusParam.toLowerCase()] : ["ACTIVE", "active", "ENROLLED", "enrolled"];
