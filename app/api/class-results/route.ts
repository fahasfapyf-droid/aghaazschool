...
export async function GET(request: NextRequest) {
  ...
  const students = await prisma.enrollment.findMany({ where: { className, ...(section ? { section } : {}), application: { sessionId } }, include: { application: true }, orderBy: { application: { studentName: "asc" } } });
